"""
Django settings for myweblog_django project.
...
UPLOAD_FOLDER = os.path.join(BASE_DIR, 'weblog/static/weblog/img')
...
ROOT_URLCONF = 'myweblog_django.urls'
...
WSGI_APPLICATION = 'myweblog_django.wsgi.application'
